sap.ui.define([
	...
	return Controller.extend("sap.gestlog.plataforma.controller.FaturamentoCarregamento", {
		...
		onConsultarFaturamentoCarregamento: function () {
		...
		// 			"TipoCargas",
		// 			"sap.gestlog.plataforma.view.RecebimentoCarregamento.fragments.valuehelps.TipoCargas",
		// 			this
		// 		);
		...
		// 			"Veiculos",
		// 			"sap.gestlog.plataforma.view.RecebimentoCarregamento.fragments.valuehelps.Veiculos",
		// 			this
		// 		);
		...
		// 			"Motoristas",
		// 			"sap.gestlog.plataforma.view.RecebimentoCarregamento.fragments.valuehelps.Motoristas",
		// 			this
		// 		);
		...
		// 			"Viagens",
		// 			"sap.gestlog.plataforma.view.RecebimentoCarregamento.fragments.valuehelps.Viagens",
		// 			this
		// 		);
