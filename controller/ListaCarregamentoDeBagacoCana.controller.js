sap.ui.define([
	...
	return Controller.extend("sap.gestlog.plataforma.controller.ListaCarregamentoDeBagacoCana", {
		...
		onAtualizarConsulta: function() {
			...
			Pendente = {
				...
				idTipoProduto: "4",
				descTipoProduto: "BAGAÇO DE CANA",
		...
		onbtnRecepcionarCarregamentoAcucar: function() {
			...
			oRouter.navTo("recebimentodebagacocana");
		},
